...
const processedVideoBucketName = "v-fragile-yt-processed-videos";
 ...
 */
export function converVideo(rawVideoName: string, processedVideoName: string) {
  return new Promise<void>((resolve, reject) => {
    ffmpeg.downgradeTo360p(
